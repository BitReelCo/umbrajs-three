import { UnsignedByteType, RGBAFormat, UnsignedShort565Type, RGBFormat, LuminanceAlphaFormat, HalfFloatType, RGBA_S3TC_DXT1_Format, RGBA_S3TC_DXT5_Format, RGB_ETC1_Format, RGBA_ASTC_4x4_Format, RGB_PVRTC_4BPPV1_Format, Object3D, MeshBasicMaterial, TangentSpaceNormalMap, Mesh, Box3, Vector3, Loader as Loader$1, Matrix4, sRGBEncoding, LinearEncoding, BufferGeometry, Sphere, Float32BufferAttribute, CompressedTexture, DataTexture, LinearFilter } from 'three';
...
// prettier-ignore
const ThreeFormats = {
    [TextureFormat.RGB24]: makeFormat(RGBFormat, UnsignedByteType, false),
    [TextureFormat.RGBA32]: makeFormat(RGBAFormat, UnsignedByteType, false),
    [TextureFormat.RGB565]: makeFormat(RGBFormat, UnsignedShort565Type, false),
    [TextureFormat.RG8]: makeFormat(LuminanceAlphaFormat, UnsignedByteType, false),
    [TextureFormat.RG16F]: makeFormat(LuminanceAlphaFormat, HalfFloatType, false),
    [TextureFormat.BC1]: makeFormat(RGBA_S3TC_DXT1_Format, UnsignedByteType, true),
    [TextureFormat.BC3]: makeFormat(RGBA_S3TC_DXT5_Format, UnsignedByteType, true),
    [TextureFormat.ETC1_RGB]: makeFormat(RGB_ETC1_Format, UnsignedByteType, true),
    [TextureFormat.ASTC_4X4]: makeFormat(RGBA_ASTC_4x4_Format, UnsignedByteType, true),
    [TextureFormat.PVRTC1_RGB4]: makeFormat(RGB_PVRTC_4BPPV1_Format, UnsignedByteType, true),
};
        ...
        this.handlers = {
            ...
            LoadTexture: (data, assetID) => {
                ...
                if ('outputEncoding' in this.renderer) {
                    ...
                    gammaOutput = this.renderer['outputEncoding'] === sRGBEncoding;
                }
                ...
                if (info.type === TextureType.Diffuse && !gammaOutput) {
                    ...
                    tex.encoding =
                        info.colorSpace === ColorSpace.Linear ? LinearEncoding : sRGBEncoding;
                }
